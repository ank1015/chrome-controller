...
import { buildPageTextEvaluationCode, createPageMarkdown } from '../page-markdown.js';
...
async function captureStablePageText(
  browserService: BrowserService,
...
async function captureStablePageSnapshot(
  browserService: BrowserService,
  session: Awaited<ReturnType<typeof resolveSession>>,
  tabId: number
): Promise<unknown> {
